...
<?php snippet('menu') ?>
  ...
  <main role="main">
    ...
    <nav class="pagination cf">
      ...
      <a class="button prev" href="<?php echo $articles->pagination()->prevPageURL() ?>">« newer posts</a>
      <?php endif ?>
      <?php if($articles->pagination()->hasNextPage()): ?>
      <a class="button next" href="<?php echo $articles->pagination()->nextPageURL() ?>">older posts »</a>
      <?php endif ?>
    </nav>
    <?php endif ?>
